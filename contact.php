...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - CONTATO </title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-content">
					<h1 class="page-titile">Contate-nos</h1>
					<ul class="banner-nav pull-right">
						<li><a href="/">Home</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li class="active"><a href="contact.php">Contate-nos</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row flex-box">
			<div class="col-md-8 col-sm-6">
				<div class="contact-us bg-gray padding30">
					<h3 class="inner-title">Entre em contato</h3>
					<span class="margin-bottom-15"></span>
					<form id="contact-form" class="contact_message" action="email.html" method="post">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="error-handel">
									...
									<div id="error"> Error ao enviar contato. Gentileza de enviar sua solicitacao a comercial@sidesafety.com</div>
								</div>
							</div>
						</div>
					</form>
			...
			<div class="col-md-4 col-sm-6">
				<div class="contact-detail padding30 color-white bg-dark">
					<h3 class="inner-title color-white">Entre em contato</h3>
					<span class="sub-title color-white">Para maiores informa&ccedil;&otilde;es sobre nossos produtos e servi&ccedil;os entre em contato.</span>
					<!--<span class="color-default">Telefones</span>
					<p>(+55)</p>
                    <p>(+54) </p>
                    -->
