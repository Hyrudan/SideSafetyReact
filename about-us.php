...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - A empresa </title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="banner-content">
						<h1 class="page-titile">SIDESAFETY
						</h1>
						<ul class="banner-nav pull-right">
							<li><a href="/">Home</a></li>
							<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
							<li class="active"><a href="about-us.php">A Empresa</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="500ms">
						<h3 class="inner-title">A Empresa</h3>
						<p>A SideSafety est&aacute; comprometida em fornecer servi&ccedil;os de alta qualidade e alto valor agregado, ajudando a tornar os locais de trabalho mais seguros.</p>
						<p>A equipe da SideSafety est&aacute; focada em fazer mudan&ccedil;as positivas na sa&uacute;de e seguran&ccedil;a no local de trabalho focado na cren&ccedil;a de que todos devem voltar para casa da mesma forma que foram trabalhar. Nosso compromisso de fornecer servi&ccedil;os de seguran&ccedil;a de alta qualidade &eacute; sustentado por um forte conjunto de valores sob os quais operamos, e a nossa capacidade de agilidade na presta&ccedil;&atilde;o de servi&ccedil;os e desenvolvimento de produtos. Nossa equipe de profissionais fornece uma abordagem coordenada e equilibrada para gerenciar a sa&uacute;de e seguran&ccedil;a no local de trabalho de forma sustent&aacute;vel.</p>
						<p>Estrat&eacute;gias para gerenciar a sa&uacute;de e seguran&ccedil;a s&atilde;o importantes para proteger as pessoas e patrim&ocirc;nios. A implementa&ccedil;&atilde;o de sistemas e estrat&eacute;gias de seguran&ccedil;a pode ser complicada e demorada.</p>
						<p>Nossos servi&ccedil;os incluem cursos de treinamento de seguran&ccedil;a, revis&otilde;es de sistemas de gerenciamento de seguran&ccedil;a, auditorias de seguran&ccedil;a e desenvolvimento e implementa&ccedil;&atilde;o de sistemas. Al&eacute;m disso, podemos fornecer recursos qualificados de sa&uacute;de e seguran&ccedil;a no local de trabalho com veicula&ccedil;&otilde;es em sua organiza&ccedil;&atilde;o</p>
						<p>Empregando um consultor de seguran&ccedil;a pode ajud&aacute;-lo a cumprir as obriga&ccedil;&otilde;es legais e melhorar a seguran&ccedil;a no seu local de trabalho.</p>
					</div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="about-video wow fadeInRight" data-wow-delay="300ms" data-wow-duration="500ms">
						<img src="images/about-us/about.jpg">
