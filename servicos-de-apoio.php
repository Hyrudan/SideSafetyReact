...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - Serviços de Apoio </title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-content">
					<h1 class="page-titile">Servi&ccedil;os de Apoio</h1>
					<ul class="banner-nav pull-right">
						<li><a href="/">Home</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li><a href="#">Servi&ccedil;os</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li class="active"><a href="#">Servi&ccedil;os de Apoio</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="full-row bg-gray">
    ...
    <a class="btn btn-primary" href="contact.php">Contato</a> </div>
				...
				<div class="row">
					<div class="col-md-12">
						<img src="images/service/ser_apoio.jpg" alt="">
					</div>
				</div>
				<div class="service-detail-content">
					<h3 class="inner-title">Servi&ccedil;os de Apoio</h3>
					<h4 class="thumb-title">Gest&atilde;o de Incidentes</h4>
					<p>Contamos com profissionais altamente experientes e capacitados para ajudar as organiza&ccedil;&otilde;es a entenderem &nbsp;as causas de incidentes acontecidos, utilizando ferramentas como ICAM, &Aacute;rvore de Falhas, Modelo de Causalidade, entre outras.</p>
					<h4 class="thumb-title">Normas Regulamentadoras</h4>
					<ul class="box-list">
					<li>Auditorias de verifica&ccedil;&atilde;o ao atendimento &agrave;s normas regulamentadoras;</li>
					<li>Elabora&ccedil;&atilde;o, implementa&ccedil;&atilde;o e revis&atilde;o de padr&otilde;es e procedimentos de atividades rotineiras com foco em seguran&ccedil;a ocupacional;</li>
					<li>Identifica&ccedil;&atilde;o de adequa&ccedil;&otilde;es para atendimento a NR-12;</li>
					<li>Identifica&ccedil;&atilde;o e mapeamento de espa&ccedil;os confinados NR-33;</li>
					<li>Elabora&ccedil;&atilde;o matriz de bloqueios NR-10.</li>
					</ul>
				</div>
			</div>
		</div>
