...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - Gestão e Gerenciamento de Riscos </title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-content">
					<h1 class="page-titile">SafetyPlus</h1>
					<ul class="banner-nav pull-right">
						<li><a href="/">Home</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li><a href="#">Produtos</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li class="active"><a href="#">SafetyPlus</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="full-row bg-gray">
    ...
    <a class="btn btn-primary" href="contact.php">Contato</a> </div>
				...
				<div class="row">
					<div class="col-md-12">
						<img src="images/products/prod_safetyplus.jpg" alt="">
					</div>
				</div>
				<div class="service-detail-content">
					<h3 class="inner-title">SafetyPlus</h3>
...
<p>O Programa Safety Plus reconhece as pessoas que tem um comprometimento com a seguran&ccedil;a e qualidade das empresas.</p>
<p>SafetyPlus &eacute; um sistema completo de acumulo de pontos de acordo com os&nbsp;crit&eacute;rios definidos pelas organiza&ccedil;&otilde;es contratantes. Quando as&nbsp;as pessoas acumulam pontos suficientes para trocar por um item de seu interesse, basta acessar o aplicativo ou site do programa para poder obter sua recompensa.</p>
<p>Principais carateristicas do sistema:</p>
<ul class="box-list">
<li>Micro-site customizado com design e logos do cliente.</li>
<img src="images/products/prod_safetyplus2.jpg">
<li>App compat&iacute;vel com Android e IOS. Customizado e publicado nas stores oficiais.</li>
<li>Sistema de atualiza&ccedil;&otilde;es autom&aacute;ticas</li>
<li>Sistema de not&iacute;cias com notifica&ccedil;&otilde;es push.</li>
<li>Loja virtual online para troca de premia&ccedil;&otilde;es.</li>
<li>Sistema web de administra&ccedil;&atilde;o de not&iacute;cias, usu&aacute;rios e loja virtual.</li>
</ul>
<img src="images/products/prod_safetyplus1.jpg">
<p><span style="font-family: verdana, geneva; font-size: 11pt;">Entre em contato para obter maiores informa&ccedil;&otilde;es ao respeito do sistema</span></p>
