...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - Seguran&ccedil;a no Tr&acirc;nsito </title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-content">
					<h1 class="page-titile">Seguran&ccedil;a no Tr&acirc;nsito</h1>
					<ul class="banner-nav pull-right">
						<li><a href="/">Home</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li><a href="#">Servi&ccedil;os</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li class="active"><a href="#">Seguran&ccedil;a no Tr&acirc;nsito</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="full-row bg-gray">
    ...
    <a class="btn btn-primary" href="contact.php">Contato</a> </div>
				...
				<div class="row">
					<div class="col-md-12">
						<img src="images/service/ser_transito.jpg" alt="">
					</div>
				</div>
				<div class="service-detail-content">
					<h3 class="inner-title">Seguran&ccedil;a no Tr&acirc;nsito</h3>
					<p>Para que uma organiza&ccedil;&atilde;o tome a&ccedil;&otilde;es bem direcionadas que previnam os incidentes com ve&iacute;culos motorizados e salvaguardem os funcion&aacute;rios, ativos e mercadorias, &eacute; preciso primeiro identificar os perigos existentes e avaliar os riscos presentes enquanto dirigem. Entender os fatores que podem contribuir a ocorr&ecirc;ncia de eventos indesejados s&atilde;o etapas fundamentais de um programa eficaz de seguran&ccedil;a no tr&acirc;nsito.</p>
<p>Na SideSafety ajudamos sua organiza&ccedil;&atilde;o a entender de melhor forma os poss&iacute;veis fatores que podem contribuir ou ser a causa de eventos, por meio de:</p>
<p>Elabora&ccedil;&atilde;o, implementa&ccedil;&atilde;o e revis&atilde;o de padr&otilde;es de seguran&ccedil;a no tr&acirc;nsito.</p>
<p>Elabora&ccedil;&atilde;o de Rotogramas: mapeamento das rotas utilizadas pelas organiza&ccedil;&otilde;es, nas quais se realiza um levantamento das condi&ccedil;&otilde;es e riscos existente ao longo da via, para logo serem plasmadas em documento vivo de uso dos motoristas da empresa.&nbsp; Este mapeamento adverte antecipadamente as poss&iacute;veis interfer&ecirc;ncias e cuidados a serem levados em conta no momento de circular pelas vias, ou a defini&ccedil;&atilde;o de novas rotas alternativas que atendam as necessidades das organiza&ccedil;&otilde;es de forma segura.</p>
<img src="images/service/ser_transito_graph1.jpg"  style="width: 711px" alt="">
				</div>
			</div>
		</div>
	</div>
