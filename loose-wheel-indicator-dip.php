...
<html lang="en">
	<head>
		...
		<title>SIDESAFETY - Indicador de porca solta - LOOSE NUT INDICATOR </title>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-content">
					<h1 class="page-titile">Indicador de Porca Solta</h1>
					<ul class="banner-nav pull-right">
						<li><a href="/">Home</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li><a href="#">Produtos</a></li>
						<li><a href="#"><span class="fa fa-angle-right"></span></a></li>
						<li class="active"><a href="#">Nut Indicator DIP</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="full-row">
    ...
    <ul class="about-category-nav">
        <li><a href="safetyplus-sistema-reconhecimento.php">SafetyPlus</a></li>
        <li><a href="loose-wheel-indicator-dip.php">Indicador Porca</a></li>
    ...
    <a class="btn btn-primary" href="contact.php">Contato</a> </div>
				...
				<div class="row">
					<div class="col-md-12">
						<img src="images/products/dip-loose-wheel-indicator.jpg" style="width: 420px" alt="">
					</div>
				</div>
				<div class="service-detail-content">
					<h3 class="inner-title">Indicador de Porca Solta</h3>
					<p></p>
					<ul class="box-list">
						<li>Fornece meios simples e visuais para confirmar o torque adequado da roda em segundos.</li>
						<li>Reduz o risco de incidentes por desprendimento de roda. (Proteger o p&uacute;blico, ajudar a evitar danos materiais).</li>
						<li>Reduza seus custos de manuten&ccedil;&atilde;o, eliminando ajustes desnecess&aacute;rios.</li>
						<li>Identifique rapidamente uma roda quente, possivelmente causada por falha do rolamento ou travagem do freio.</li>
						<li>Diminua o tempo de inatividade do equipamento.</li>
						<li>Facilita inspe&ccedil;&otilde;es oficiais na estrada.</li>
						<li>Claramente vis&iacute;vel &agrave; noite e em mau tempo (chuva, neve, lama).</li>
						<li>F&aacute;cil de instalar.</li>
						<li>Custe apenas alguns d&oacute;lares por roda.</li>
						<li>Retorno do investimento s&oacute; na economia de procedimento de re-ajuste desnecess&aacute;rio.</li>
					</ul>
					<!--<h3 class="inner-title">Service Advantage</h3>
					<p>Tincidunt. Vivamus nascetur turpis pulvinar libero. Porta. Consectetuer eleifend phasellus mus nam vivamus. Consectetuer. Vel luctus dapibus nec primis nibh pharetra accumsan nisl porta. Habitant dictumst litora class, porttitor primis. Tempus id consectetuer est senectus nisi nam auctor dictum venenatis quisque. Hymenaeos integer. Pede vestibulum.</p>
					<p>Hendrerit. Nascetur varius dictum arcu ultricies arcu phasellus sociis rutrum a, integer vehicula feugiat ridiculus mus adipiscing magna posuere malesuada. Gravida faucibus. Lobortis curabitur quisque.</p>
					<div class="row">
						<div class="margin-30">
							<div class="col-md-4">
								<div class="special-service-item text-center">
									<span class="flaticon-security-on bg-default"></span>
									<h5 class="thumb-title">Sequre Payment</h5>
									<p>Fames condimentum hendrerit at hymenaeos pellentesque donec ornare sociis sociosqu.</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="special-service-item text-center">
									<span class="flaticon-account-passkey bg-default"></span>
									<h5 class="thumb-title">Best Data Security</h5>
									<p>Fames condimentum hendrerit at hymenaeos pellentesque donec ornare sociis sociosqu.</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="special-service-item text-center">
									<span class="flaticon-policeman bg-default"></span>
									<h5 class="thumb-title">Qualified Guardst</h5>
									<p>Fames condimentum hendrerit at hymenaeos pellentesque donec ornare sociis sociosqu.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="no-padding info-pages margin-top-50">
						<h3 class="inner-title">Popular Question</h3>
						<div class="according">
							<div class="according_area">
								<div class="according_title active">How to get Appoinment ?</div>
							...
							<div class="according_area">
								<div class="according_title">How to provide the personal security ?</div>
								<div class="according_details">
							...
							<div class="according_area">
								<div class="according_title">What is legality and trust of your company ?</div>
								<div class="according_details">
									<p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus semper amet cum condimentum lobortis pellentesque suscipit. Nisi porta at.</p>
								</div>
							</div>
							...
							<div class="according_area">
								<div class="according_title">Which technology use for home security system ?</div>
								<div class="according_details">
									<p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus semper amet cum condimentum lobortis pellentesque suscipit. Nisi porta at.</p>
								</div>
							</div>
							<div class="according_area">
								<div class="according_title">What is the payment process ?</div>
								<div class="according_details">
									<p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus semper amet cum condimentum lobortis pellentesque suscipit. Nisi porta at.</p>
								</div>
							</div>
							<div class="according_area">
								<div class="according_title">Who take the responsibility, if loss any thing ?</div>
								<div class="according_details">
									<p>Cubilia suspendisse, sodales Eu odio. Ad sollicitudin Mollis euismod natoque dis arcu vel fusce mattis metus taciti pellentesque netus malesuada. Vulputate nisi taciti netus leo lobortis est at leo. Tellus semper amet cum condimentum lobortis pellentesque suscipit. Nisi porta at.</p>
								</div>
							</div>
